...
read
    ...
    bind_profile == local AND profile chosen AND FRAUDFUSION_S2S_TOKEN unset
...
from soc_fraud_fusion.adapters.local.identity import (
    LocalIdentityAdapter,
)
from soc_fraud_fusion.adapters.onprem.identity import (
