...
from soc_fraud_fusion.agent import (
    SKILLS,
    TOOL_FUNCTIONS,
    agent_card_document,
    build_agent_card,
...
def test_the_card_document_is_json_safe_and_names_the_region() -> None:
    ...
    assert document["name"] == "soc-fraud-fusion"
...
def test_the_agent_path_routes_an_escalation_rather_than_only_flagging_it() -> None:
    result = triage_incident(
        ...
        sample_cases.ESCALATING_CASE.scope,
...
def test_the_draft_runbook_tool_returns_grounded_steps() -> None:
