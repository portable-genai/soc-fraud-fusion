# SOC Fraud Fusion Copilot (G5) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    FRAUDFUSION_PROFILE=gcp \
    FRAUDFUSION_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn soc_fraud_fusion.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
