...
loopback and exits non-zero when a claim stops being true; `.github/workflows/demo-gate.yaml` runs
...
Yes. `.github/workflows/ci.yaml` is a thin caller of a shared reusable hard-gate workflow pinned
